...
1) Don't waste your time trying to find something that could get be me in trouble. Everything is FOIA-cerfiied.
2) As more FOIA-certified documents are declassfiied, this list will be updated over time (I work in space/software, and it is a lot).
3) Feel free to add/contribute by making a branch -> PR (standard contributor practice, depite this being a codeless repository)
